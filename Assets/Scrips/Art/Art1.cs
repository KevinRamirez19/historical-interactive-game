...
public class Art1 : MonoBehaviour
{
    ...
    public string gameProgressMessage = "Primer objeto recogido"; // Mensaje específico para este artefacto
    public string descriptionMessage = "El jugador ha recogido exitosamente el primer objeto, ahora se dirige al segundo."; // Descripción específica

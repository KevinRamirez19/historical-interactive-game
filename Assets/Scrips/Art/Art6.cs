...
public class Art6 : MonoBehaviour
{
    public int gameProgressId = 1; // ID único para cada artefacto
    public string gameProgressMessage = "Sexto objeto recogido"; // Mensaje específico para este artefacto
    public string descriptionMessage = "El jugador ha recogido exitosamente el sexto objeto, ahora se dirige al punto de entrega."; // Descripción específica

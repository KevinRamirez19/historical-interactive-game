...
public class Art3 : MonoBehaviour
{
    ...
    public string gameProgressMessage = "Tercer objeto recogido"; // Mensaje específico para este artefacto
    public string descriptionMessage = "El jugador ha recogido exitosamente el tercer objeto, ahora se dirige al cuarto."; // Descripción específica

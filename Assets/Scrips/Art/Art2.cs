...
public class Art2 : MonoBehaviour
{
    ...
    public string gameProgressMessage = "Segundo objeto recogido"; // Mensaje específico para este artefacto
    public string descriptionMessage = "El jugador ha recogido exitosamente el segundo objeto, ahora se dirige al tercero."; // Descripción específica

...
public class Art4 : MonoBehaviour
{
    ...
    public string gameProgressMessage = "Cuarto objeto recogido"; // Mensaje específico para este artefacto
    public string descriptionMessage = "El jugador ha recogido exitosamente el cuarto objeto, ahora se dirige al quinto."; // Descripción específica

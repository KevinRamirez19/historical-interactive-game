...
public class Objeto1 : MonoBehaviour
{
    ...
    public string gameProgressMessage = "Primer mensaje recogido"; // Mensaje específico para este artefacto
    public string descriptionMessage = "El jugador ha recogido exitosamente el primer mensaje, ahora se dirige a entregarlo."; // Descripción específica

...
public class Objeto4 : MonoBehaviour
{
    ...
    public string gameProgressMessage = "Cuarto mensaje recogido"; // Mensaje específico para este artefacto
    public string descriptionMessage = "El jugador ha recogido exitosamente el cuarto mensaje, ahora se dirige a hacer la ultima entrega."; // Descripción específica

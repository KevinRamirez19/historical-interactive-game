...
public class Objeto3 : MonoBehaviour
{
    ...
    public string gameProgressMessage = "Tercer mensaje recogido"; // Mensaje específico para este artefacto
    public string descriptionMessage = "El jugador ha recogido exitosamente el tercer mensaje, ahora se dirige a entregarlo."; // Descripción específica

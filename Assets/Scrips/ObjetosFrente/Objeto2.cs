...
public class Objeto2 : MonoBehaviour
{
    ...
    public string gameProgressMessage = "Segundo mensaje recogido"; // Mensaje específico para este artefacto
    public string descriptionMessage = "El jugador ha recogido exitosamente el segundo mensaje, ahora se dirige a entregarlo."; // Descripción específica
